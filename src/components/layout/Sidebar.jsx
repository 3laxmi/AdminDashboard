...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { path: "/sales", label: "Order", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
  ];
  
  return (
    // <aside className="bg-gray-800 text-white w-64 fixed left-0 top-16 bottom-0 overflow-y-auto">
      <aside className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white w-64 fixed left-0 top-16 bottom-0 overflow-y-auto">
      <nav className="p-4">
        <ul className="space-y-2">
          ...
          <li>
            <button
              ...
              className="flex items-center justify-between w-full px-4 py-3 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition"
            >
